<div class="scroll">
    <div class="prod">
        <div class="colu1">
            <div class="tag1">
                <p class="name1">Норіакі</p>
                <div class="line1"></div>
            </div>
            <div class="tovar">
                <img class="tovar1" src="noriaki.jpg" alt="donut">
            </div>
        </div>
        <div class="colu">
            <div class="butt1">
            ...
            <div class="sklad">
                <p class="textsklad">Склад: борошно в/г, концентрат для пончиків (рослинний жир, сіль, білок, суха
                    сиворотка,
                    розпушувач, прянощі, дріжджі пресовані, цукор, вода, заварний крем, цукор, пудра</p>
            </div>
        </div>
    ...
    <div class="hot">
        <div class="shab">
            <div class="shab_name">Р.Нерро</div>
            <p class="feedshab">
                Найзвичніші мені солодощі, що повертають відчуття дому та дитинства. З нетерпінням чекаю
                на кожен новий рецепт, який з'явиться в кондитерській. Дякую за те що ви є.
            </p>
        </div>
        <div class="shab">
            <div class="shab_name">П.Жан</div>
            <p class="feedshab">
                Першим ділом зранку відвідую кондитерську заради червоних пончиків! Улюблені ласощі в усьому місті!
            </p>
        </div>
        <?php
			if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['feedback'])) {
				...
				echo '<div class="shab">
					<div class="shab_name">'.$name. '</div>
					<p class="feedshab">'.$feedback.'</p>
				</div>';
			}
		?>
    </div>
    <div class="comentar">
        ...
        <div class="vidhuk">
            <form class="form" action="?page=index4" method="post">
                <div class="comname">
                ...
                <textarea class="comentar1" type="text" name="feedback" id="feedback"></textarea>
                <button class="post">Додати відгук</button>
            </form>
        </div>
    </div>
</div>